...
public class EmployeeController {
	...
	@GetMapping("/employee-by-dept/{dept}")
	public List<Employee> getEmployeeByDept(@PathVariable String dept)
	{
		return employeeService.findByDept(dept);
	}

	@GetMapping("/employee-by-age-lessthan/{age}")
	public List<Employee> getEmployeeByDept(@PathVariable int age)
	{
		return employeeService.getEmployeeByAgeLessThan(age);
	}
